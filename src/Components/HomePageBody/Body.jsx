        ...
        <div className={styles.contentBoxes}>
          ...
          <div className={styles.box1}>
            ...
            >
              ...
              <Box w={"max-content"} h="max-content" m={"auto"} mt="4">
                <Link p={"2"} color={"twitter.500"} fontSize={"md"} m={"auto"}>
            ...
            <Flex w={"100%"} h="220px" mt={"6"} justifyContent="space-between">
              <Box
                h={"100%"}
                w="48%"
                bg="#fff"
          ...
          <div className={styles.box2}>
            ...
            <Box
              ...
              bg="#fff"
            >
              <Box w="100%" h="70px" borderBottom={"darkgray"} p="6" className={styles.faq}>
